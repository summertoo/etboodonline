...
export const metadata: Metadata = {
  title: "What We Do",
  description:
    "Learn about ZD Tech's expertise in decentralized application development, Web3 gaming, and blockchain solutions on Sui network.",
};
    ...
    <div className="max-w-7xl mx-auto px-4 cyber-container fly-in">
      ...
      <section className="text-center py-20 cyber-hero">
        ...
        <p className="mb-8 cyber-subtitle max-w-2xl mx-auto">
          We build decentralized applications, web3 games, and creative tools on
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-xl border border-[var(--cyber-border)] bg-white text-center">
            ...
            <p className="cyber-subtitle">
              Full-stack decentralized application development on Sui Network,
              from smart contracts to frontend interfaces.
            </p>
          </div>
          <div className="p-8 rounded-xl border border-[var(--cyber-border)] bg-white text-center">
            <div className="text-4xl mb-4">🎮</div>
            ...
            <p className="cyber-subtitle">
              Browser-based and Roblox games with blockchain integration, NFT
              assets, and play-to-earn mechanics.
            </p>
          </div>
          <div className="p-8 rounded-xl border border-[var(--cyber-border)] bg-white text-center">
            ...
            <p className="cyber-subtitle">
              Architecture design, code review, and technical guidance for
              blockchain projects and teams.
            </p>
          </div>
        </div>
      </section>
