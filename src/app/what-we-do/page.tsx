        ...
        <section className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: "🌐",
                titleKey: "whatwedo.dappTitle",
                descKey: "whatwedo.dappDesc",
              },
              {
                icon: "🎮",
                titleKey: "whatwedo.gameTitle",
                descKey: "whatwedo.gameDesc",
              },
              {
                icon: "🛠️",
                titleKey: "whatwedo.consultTitle",
                descKey: "whatwedo.consultDesc",
              },
            ].map((item, i) => (
              <div
                key={i}
