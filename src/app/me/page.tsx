...
export default function MePage() {
  ...
  const likedProjects = useMemo(() => {
    const liked = new Set(
      centerData?.likes.map((item) => item.project_id) || [],
    );
                  ...
                  centerData.comments.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="mt-1 text-sm cyber-subtitle">
                          {item.content}
                        </p>
