...
import { newsCategoryMeta } from "@/data/news-meta";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {webGames.map((game, i) => (
              <GameCard
                ...
                liveUrl={getProjectDetailPath(game, lang)}
                status={game.status}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {dapps.map((dapp, i) => (
              <ProjectCard
                ...
                liveUrl={getProjectDetailPath(dapp, lang)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {stableGateway && (
              <ProjectCard
                ...
                liveUrl={getProjectDetailPath(stableGateway, lang)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {suiBestPractices && (
              <ProjectCard
                ...
                liveUrl={getProjectDetailPath(suiBestPractices, lang)}
