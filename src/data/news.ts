...
export const newsList: NewsItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: { zh: "苹果发布第三代 Apple Foundation Models", en: "Apple Releases AFM3" },
        description: {
      ...
      {
        title: { zh: "高德发布 3D 原生城市世界模型", en: "Amap Releases 3D City World Model" },
        description: {
      ...
      {
        title: { zh: "OpenAI 向 SEC 机密提交 S-1 草案", en: "OpenAI Files S-1 Confidentially" },
        description: {
      ...
      {
        title: { zh: "NVIDIA 与 LG 合作建设 AI 工厂", en: "NVIDIA LG AI Factory Partnership" },
        description: {
      ...
      {
        title: { zh: "Perplexity + 哈佛：AI 智能体提效 87%", en: "Perplexity Harvard: AI Agents 87% Faster" },
        description: {
  ...
  },
  {
    ...
    items: [
      {
        title: { zh: "ChatGPT 转型超级应用 AgentGPT", en: "ChatGPT Becomes AgentGPT Super App" },
        description: {
      ...
      {
        title: { zh: "Harness-1: 20B 强化学习检索智能体", en: "Harness-1: 20B RL Retrieval Subagent" },
        description: {
      ...
      {
        title: { zh: "RTX Spark 登陆韩国：NVIDIA 与游戏厂商合作", en: "RTX Spark Launches in Korea" },
        description: {
      ...
      {
        title: { zh: "苹果秘密会议：终于认真对待 AI", en: "Apple Secret Meeting: Finally Serious About AI" },
        description: {
      ...
      {
        title: { zh: "Opus 4.8 缓存命中率与价格可实时查看", en: "Opus 4.8 Cache Hit Rate Now Visible" },
        description: {
      ...
      {
        title: { zh: "Her: Claude Code 会话分析工具", en: "Her: Claude Code Session Analyzer" },
        description: {
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: { zh: "张桂梅送考与学生齐唱《万疆》", en: "Zhang Guimei Sees Off Students, Sings Together" },
        description: {
      ...
      {
        title: { zh: "暴雨预警升级橙色！5省有大暴雨", en: "Heavy Rain Warning: 5 Provinces" },
        description: {
      ...
      {
        title: { zh: "本月起工资或多一笔钱", en: "Salary Extra Payment This Month" },
        description: {
      ...
      {
        title: { zh: "宇树回应联手英伟达", en: "Unitree Responds to Nvidia Partnership" },
        description: {
      ...
      {
        title: { zh: "伊朗世界杯代表团遭美拒签", en: "Iran World Cup Delegation Denied US Visa" },
        description: {
      ...
      {
        title: { zh: "高考后需警惕高发骗局", en: "Post-Gaokao Fraud Prevention" },
        description: {
      ...
      {
        title: { zh: "人数降了招生多了这届高考难吗", en: "Fewer Test Takers, More Admissions" },
        description: {
